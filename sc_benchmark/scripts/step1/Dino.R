...
#统计运行时间、资源占用
system("bash ./sc_benchmark/scripts/start_monitor.sh -n ./sc_benchmark/output/step1/Dino/usage -t 180")
...
save(dat, file = "./sc_benchmark/output/step1/Dino/Dino.RData")
load("./sc_benchmark/output/step1/Dino/Dino.RData")
...
png("./sc_benchmark/output/step1/Dino/Dino_umap.png", height=768, width=768)
DimPlot(scRNA, reduction = "umap", group.by = "RNA_snn_res.0.25") + ggtitle("louvain_0.25")
dev.off()
...
write.table("-----Dino_nomorlization-----",output_txt, row.names=F, quote=FALSE, col.names = FALSE, append = TRUE)
